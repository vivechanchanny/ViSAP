    ...
    var internal = {
        ...
        question_created: function (questData, fnPreSend, fnSuccess, fnError) {
            ...
            if (actionType !== "update") {
                var qtag = internal.getTagName(); // get tag name.
                ...
                ViTag.UpdateAelibQues(fnPreSend, fnSuccess, fnError);
        ...
        continueVideo: function (msg) {
            ...
            $("#slider").hide(1000);
            //TO DO: $("body").triggerHandler("showSliderContent","tags");
        ...
        getTagName: function(){
          var tag =  $('#aelibTagList option:selected').val(); // get tag value.
          return tag;
        },
            ...
            for (var i = 0; i < pausedLstAction.length; i++) {
                if (pausedLstAction[i].data.questionId === questionId) {
                    if (isQuesEdit === true) {
                        ...
                        pausedLstAction[i].data.qtag = internal.getTagName();
                }
            }
        }
    };
