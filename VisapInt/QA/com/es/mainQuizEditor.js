    ...
    var v = function() {
        var e, v, m, g = null,
            ...
            k = function(e, l, p) {
                ...
                init: function(e) {
                    var t = this;
                    QUIZ_EDITOR_CONSTANTS.SERVICE_BASE_URL = e.baseServiceURL, QUIZ_EDITOR_CONSTANTS.BOOK_ID = e.videoId, $.getScript("QA/com/external/ckeditor/ckeditor.js", function() {
                        var n = location.href.split("#")[0],
                            r = window.location.pathname.split("/")[1],
                            i = window.location.origin + "/" + r + "/QA/com/external/ckeditor/";
                        CKEDITOR.basePath = i;
                        var s = e.quesType,
                            o = e.QuesContainer,
                            u = e.url,
                            a = e.quesId;
                            $("#showQuizType").html("");
                        e.quesId ? QUIZ_EDITOR_CONSTANTS.QUES_ID = e.quesId : QUIZ_EDITOR_CONSTANTS.QUES_ID = "", e.url && (QUIZ_EDITOR_CONSTANTS.QUESTION_ASSET_BASE_PATH = e.url.substr(0, e.url.lastIndexOf("/") + 1)), N = s, k(s, o, u),
