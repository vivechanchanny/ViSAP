...
_ToolManDragGroup.prototype = {
	...
	setHandle : function(handle) {
		...
		events.register(handle, ToolMan.dragEvents[0], this._dragInit)
		handle.onmousedown = function() { return false }

		if (this.element != handle)
			events.unregister(this.element, ToolMan.dragEvents[1], this._dragInit)
	},
	...
	_dragInit : function(event) {
		...
		ToolMan.events().register(document, ToolMan.dragEvents[1], group._drag)
		document.onmousemove = function() { return false }
		ToolMan.events().register(document, ToolMan.dragEvents[2], group._dragEnd)
	...
	_dragEnd : function(event) {
		...
		ToolMan.events().unregister(document, ToolMan.dragEvents[1], group._drag)
		document.onmousemove = null
		ToolMan.events().unregister(document, ToolMan.dragEvents[2], group._dragEnd)
	},
