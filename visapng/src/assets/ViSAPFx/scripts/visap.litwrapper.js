    ...
    var internal = {
        ...
        createSketchTools: function (pickerElement, optionsElement) {
            ...
            var markup = "<div class='sketchtools'>";
             if(!internal.options.skipDurationFiled){
                ...
                markup += "<span class='wrgmsg'>*</span></div></div>";
             }
            markup += "</div>";
      ...
      //  internal.options.wbTxtHeight = height;
       // internal.options.wbTxtWidth = width;
        ...
        if(el != undefined){
            ...
            var backingScale = LC.util.getBackingScale(ctx);
            console.log(backingScale);
            LC.util.matchElementSize(elementToMatch, [el], backingScale, () => {
            internal.options.lc.repaintAllLayers();
