...
(function (ns) {
    ...
    ns.categoryTOC = function(category)
    {
         ...
         sessionStorage.setItem('catgoryName',category);
     ...
     ns.getCategoryView =  function (source,type) {
           ...
           if(list!= null && list.Categories.length > 0)
           {
    ...
    ns.doVidSearch = function (opt) {    
        ...
        var userName = sessionStorage.getItem('AppUser');	 
		var loggedUserRole = sessionStorage.getItem('role'); 
 ...
 ns.distinctCategories = function(){
          ...
          $.ajax({            
                ...
                type: "POST",
                headers: { isStage: false, "X-HTTP-Method-Override": "GET", 'X-Authorization': sessionStorage.getItem('authT') },
                async: false,
                success: function (data) {               
    ...
    var internal = {
        ...
        loadTOCView: function(){
            var categoryName = sessionStorage.getItem('catgoryName');
