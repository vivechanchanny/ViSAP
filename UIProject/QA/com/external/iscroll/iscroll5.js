...
// INSERT POINT: _init
	...
	_start: function (e) {
		...
		if ( this.options.preventDefault && !utils.isAndroidBrowser && e.target.nodeName.toLowerCase() != "select" && e.target.nodeName.toLowerCase() != "input" && e.target.nodeName.toLowerCase() != "textarea"  && !e.target.getAttribute("contenteditable") && $(e.target).parents(".contentArea").length == 0) {
...
// INSERT POINT: _wheel
	...
	handleEvent: function (e) {
		switch ( e.type ) {
			case 'touchstart': $(this.wrapper).find(".iScrollLoneScrollbar").css("opacity","1");
			case 'MSPointerDown':
			case 'mousedown':
				this._start(e);
				break;
			...
			case 'mousemove':
				this._move(e);
				break;
			case 'touchend': _.delay(function(){$(this.wrapper).find(".iScrollLoneScrollbar").css("opacity","0");},2000);
			case 'MSPointerUp':
			case 'mouseup':
			case 'touchcancel': 
...
function createDefaultScrollbar (direction, interactive, type) {
	...
	if ( type === true ) {
		scrollbar.style.cssText = 'position:absolute;z-index:9';
