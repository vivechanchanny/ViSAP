...
var CirclePlayer = function(containerRef,jPlayerSelector, media, options) {
	var	self = this,
	...
	this.player = $(self.containerRef).find(jPlayerSelector);
	...
	$.each(cssSelector, function(entity, cssSel) {		
		self.jq[entity] = $(self.options.cssSelectorAncestor + " " + cssSel,self.containerRef);		
	});
