        ...
        return {
            ...
            animate : (function() {
                ...
                return function( elem, to, options ) {
                    ...
                    $("#widgetContent").css({'height':$('#widgetContent').parent().height()}); // browser scaling fix
                };
            }()),
    ...
    */
    ...
    init: function( target, options ) {
        ...
        this._options = {
            ...
            fullscreenDoubleTap: false, // 1.2.4 toggles fullscreen on double-tap for touch devices
    ...
    _createThumbnails : function( push ) {
        ...
        for( ; this._data[ i ]; i++ ) {
            ...
            //src = "images/circle-grey.png"; // explicitly set to the circle image so that if thumnail image is not found then even circle image appears
    ...
    */
    ...
    show : function( index, rewind, _history ) {
        ...
        if ( swipe ) {       
            ...
            if ( this.getDataLength() > 1 ) {            
                if($(".more-less-description").html() === WIDGET_CONSTANTS.DESCRIPTION_COLLAPSE){
                    $(".more-less-description",this._options.widgetRef).trigger(WIDGET_EVENTS.CLICK);    
                }                
            }
    ...
    _show : function() {
        ...
        next.load( src, function( next ) {
            ...
            if ( self.getDataLength() > 1 ) {
                if($(".more-less-description").html() === WIDGET_CONSTANTS.DESCRIPTION_COLLAPSE){
                    $(".more-less-description",self._options.widgetRef).trigger(WIDGET_EVENTS.CLICK);    
                }                
            }
    ...
    Finger.prototype = {
        ...
        ontouchend: function(e) {
            ...
            var isValidSlide = +new Date() - this.start.time < 250 &&
                ...
                computedIndex = this.index + ( isValidSlide && !isPastBounds ? (this.deltaX < 0 ? 1 : -1) : 0 );
                
                if (isValidSlide && (computedIndex == this.index) && (parseInt(this.index, 10) === parseInt(this.length - 1, 10)) ) {
                	computedIndex = 0;
                } else if (isValidSlide && (computedIndex == this.index) && (parseInt(this.index, 10) === 0)) {
                	computedIndex = parseInt(this.length - 1, 10);
                }

            // if not scrolling vertically
            if ( !this.isScrolling ) {
                this.show( computedIndex );
            }
