	...
	*/
	...
	Panzoom.prototype = {
		...
		setMatrix: function( matrix, options ) {
			...
			var temp_matrix4 = matrix[4];
			var temp_matrix5 = matrix[5];
			...
			if ( contain ) {
				...
				matrix[4] = isNaN(matrix[4]) ? temp_matrix4 : matrix[4];
				matrix[5] = isNaN(matrix[5]) ? temp_matrix5 : matrix[5];
		...
		_bind: function() {
			...
			var str_stop = pointerEvents ? 'pointerup' + ns : ('touchend' + ns + ' mouseup' + ns);
			var str_leave = ' mouseleave' + ns;
			...
			if ( !options.disablePan || !options.disableZoom ) {
				...
				events[ str_stop ] = events[ str_leave ] = function( e ) {
					console.log("----str_stop --- on mouse leave");
