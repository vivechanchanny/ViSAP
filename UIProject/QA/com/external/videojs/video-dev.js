...
vjs.getAndroidVersion = function(){
...
vjs.Slider.prototype.onMouseDown = function(event){
  ...
  this.on($(this.contentEl()).closest('body'), 'mouseup', this.onMouseUp);
  this.on(this, 'touchmove', this.onMouseMove);
  this.on(this, 'touchend', this.onMouseUp);
...
vjs.Slider.prototype.onMouseUp = function() {
  ...
  this.off(this, 'mousemove', this.onMouseMove);
  this.off($(this.contentEl()).closest('body'), 'mouseup', this.onMouseUp);
  this.off(this, 'touchmove', this.onMouseMove);
  this.off(this, 'touchend', this.onMouseUp);
...
vjs.PlayToggle.prototype.onToggleClicked_ = false;
// OnClick - Toggle between play and pause
vjs.PlayToggle.prototype.onClick = function(){
  if(this.onToggleClicked_){
    return;
  }
  this.onToggleClicked_ = true;
...
if((vjs.getAndroidVersion())>=5 || (vjs.getAndroidVersion())==0){
...
vjs.MediaTechController.prototype.onTap = function(){
 //  this.player().userActive(!this.player().userActive());  
  if (this.player().controls()) {
    if (this.player().paused()) {
      this.player().play();
    }else if(this.player().userActive()){
      this.player().pause();
    }else{
      this.player().userActive(!this.player().userActive());
    }
